...
hamester_mouse = read.csv("hamester_to_mouse_Ensembl_v100.csv", stringsAsFactors = F) %>% .[grep("ENSMUSG0", .$Gene.stable.ID),]
hamester_mouse = hamester_mouse[!duplicated(hamester_mouse$Gene.stable.ID),]
hamester_mouse = hamester_mouse[!duplicated(hamester_mouse$Golden.Hamster.gene.stable.ID),]
hamester_mouse = hamester_mouse[hamester_mouse$Golden.Hamster.gene.stable.ID != "",]
